...
pattern = re.compile(r"def fetch_motw_manager_data\(target_gw: int\):.*?return None", re.DOTALL)

new_func = '''def fetch_motw_manager_data(target_gw: int):
    motw_id = None
    motw_score = None
    fallback_used = False
    try:
