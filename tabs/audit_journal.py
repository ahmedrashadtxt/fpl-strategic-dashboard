...
def render_audit_journal_tab(conn, events_df, current_gw, player_pool_df=None):
    ...
    if "Pitch" in view_mode:
        ...
        st.dataframe(table_starters, width='stretch', hide_index=True)
        ...
        if not bench_df.empty:
            ...
            st.dataframe(table_bench, width='stretch', hide_index=True)
    ...
    if is_settled:
        ...
        with r1:
            ...
            st.dataframe(over_table, hide_index=True, width='stretch')
        ...
        with r2:
            ...
            st.dataframe(under_table, hide_index=True, width='stretch')